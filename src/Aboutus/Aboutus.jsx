  ...
  return (
    <div className="aboutus">
      ...
      <div className="header">
        ...
        <p>These beautiful styles come in flats, wedges and heels, further enhanced with a stylish organza bag and a golden shoe box.</p>
        ...
        <p>Our products are carried by retailers who simultaneously carry other luxurious and high-end brands globally. Some of them to name a few :</p>
        <ul>
        <li><strong>Kitson-Kitross at LA,</strong> which is well-known in USA for the shopping paradise of celebrities. One of our style was highlighted on the home page of KITSON's website, and several styles are being sold in their online and physical stores.</li>
        <li><strong>Rodeo Boutiques</strong> at Atlantis The Palm, Dubai</li>
        <li><strong>Beach Bunny</strong> at La Mer, Dubai</li>
        <li><strong>Boutiques </strong>at Baha Mar, Bahamas</li>
        <li><strong>Pasha Flagship Stores</strong>, Central America</li>
        </ul>
        <p>Our quality designs are now featured globally in renowned media and adorned by international figures.</p>
        <p>PASHA&rsquo;s Corporate Social Responsibility (CSR) extends with an active participation in O.C.A.D</p>
        <br/>
        <div class="flex">
        <div className="wrapper">
          ...
          <p className="content4p">
          Pasha’s social work in Central America supports O.C.A.D <br/>
          foundation in combating child malnutrition
          </p>
          </div>
